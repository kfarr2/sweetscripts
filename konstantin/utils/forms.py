...
class SickFormWrapper(object):
    def __getitem__(self, name):
        """
        Add some useful attributes to the boundfield objects
        """
        bound_field = super(SickFormWrapper, self).__getitem__(name)
...
class SickForm(SickFormWrapper, Form):
    pass

class SickModelForm(SickFormWrapper, ModelForm):
    pass

forms.Form = SickForm
forms.ModelForm = SickModelForm
